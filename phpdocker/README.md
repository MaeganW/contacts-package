...
Simply, unzip the file into your project, this will create `docker-compose.yml` on the root of your project and a folder named `phpdocker` containing nginx and clevyr-laravel config for it.
...
Note: you may place the files elsewhere in your project. Make sure you modify the locations for the clevyr-laravel dockerfile, the php.ini overrides and nginx config on `docker-compose.yml` if you do so.
...
------|---------|-----------
clevyr-laravel|clevyr-laravel|9000
